...
class GNN(nn.Module):
    ...
    def __init__(self, periods, nodes, edge_index, edge_weights, batch_size):
        ...
        self.model = gnn.Sequential('x, edge_index, edge_weight', [
            (TGCN2(in_channels=2*periods, out_channels=periods, batch_size=batch_size), 'x, edge_index, edge_weight -> x'),
            nn.ReLU(),
            (TGCN2(in_channels=periods, out_channels=periods, batch_size=batch_size), 'x, edge_index, edge_weight -> x'),
            nn.ReLU(),
